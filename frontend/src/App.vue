...
<template>
    ...
    <TemplateComponent :ActiveComponent="ComponentStatus" :systemStatus="systemStatus" @ChangeSystemStatus="ChangeSystemStatus" @ChangeExperimentStatus="ChangeExperimentStatus"/>
